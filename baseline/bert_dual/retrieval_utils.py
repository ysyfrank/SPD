...
parser.add_argument("--query_path", default="/mnt/xxx/data/msmarco-data/msmarco-docdev-queries.tsv", type=str, help='data path')
parser.add_argument("--qrels_path", default="/mnt/xxx/data/msmarco-data/msmarco-docdev-qrels.tsv", type=str, help='data path')
...
if __name__ == "__main__":
    query_emb_path = "/mnt/xxx/data/dual_data/bert_512_query_top_300w.txt"
    doc_embed_path = "/mnt/xxx/data/dual_data/bert_512_doc_top_300w.txt"
    args.qrels_path = "/mnt/xxx/data/msmarco-data/msmarco-docdev-qrels.tsv"
